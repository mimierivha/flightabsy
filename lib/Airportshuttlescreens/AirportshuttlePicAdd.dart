...
class AirportAddpicScreen extends StatefulWidget {
  @override
  _LoginState createState() => _LoginState();
}

class _LoginState extends State<AirportAddpicScreen> {
  ...
  Future addProduct() async{
    ...
    final request = await http.MultipartRequest(
      ...
      Uri.parse(baseDioSingleton.AbisiniyaBaseurl + 'shuttle/pictures/add'),
    );
    request.headers.addAll(header);
    request.fields['shuttle_id'] = AirportshuttleID.toString();
   // request.fields['pictures[]'] = '[]';
    ...
    print(response);
    print('Airportshuttle code...');
    print(response.statusCode);
    if(response.statusCode == 201) {
      print('img added successfuly in Airportshuttle...');

...
class CreateBusshuttleScreen extends StatefulWidget {

  @override
  _LoginState createState() => _LoginState();
}

class _LoginState extends State<CreateBusshuttleScreen> {
  ...
  Future addProduct() async{
    ...
    final request = await http.MultipartRequest(
      ...
      Uri.parse(baseDioSingleton.AbisiniyaBaseurl + 'shuttle/store'),

...
class AirportShuttleEdit extends StatefulWidget {

  @override
  _LoginState createState() => _LoginState();
}

class _LoginState extends State<AirportShuttleEdit> {
  ...
  _retrieveValues() async {
    ...
    setState(() {
      ...
      seaterController.text = prefs.getString('seaterkey') ?? "";
      ...
      AirportshuttleID = prefs.getInt('AirportshuttleIdkey') ?? 0;
      print('AirportshuttleID price...');
      print(RetrivedPrice);
...
// List of items in our dropdown menu
  ...
  Future<String> Update() async {
    String url = baseDioSingleton.AbisiniyaBaseurl + 'shuttle/update/$AirportshuttleID';
    print('url...');
    print(url);
    final response = await http.put(
      Uri.parse(baseDioSingleton.AbisiniyaBaseurl + 'shuttle/update/$AirportshuttleID'),

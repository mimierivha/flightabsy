...
import 'AirportshuttleManagepic.dart';
import 'AirportshuttlePicAdd.dart';
import 'AirportshuttleReviewRating.dart';
//import 'ViewManagePicturesVC.dart';
//import 'NewUserbooking.dart';
class ViewAirportshuttleBookingScreen extends StatefulWidget {
  const ViewAirportshuttleBookingScreen({super.key});

  @override
  State<ViewAirportshuttleBookingScreen> createState() => _userDashboardState();
}

class _userDashboardState extends State<ViewAirportshuttleBookingScreen> {
...
//@override
  ...
  Future<dynamic> Review() async {
    ...
    print('review apt id');
    print(AirportshuttleID);
    //https://staging.abisiniya.com/api/v1/rating/shuttle/avgrating/14
    String url = baseDioSingleton.AbisiniyaBaseurl + 'rating/shuttle/avgrating/$AirportshuttleID';
                                                        ...
                                                        Row(
                                                          children: [
                                                            Container(
                                                              ...
                                                              width: 140,
                                                              color: Colors.white,
                                                              child: Text('Seats:',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500),),
                                                            ),
                                                            Container(
                                                              height: 30,
                                                              width: 200,
                                                              color: Colors.white,
                                                              child:Text(snapshot.data?['data'].isEmpty ? 'Empty name'
                                                                  : snapshot.data?["data"][index]?['seater']?.toString() ?? 'empty'),
                                                            )
                                                          ],
                                                        ),
                                                        Row(
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async{
                                            ...
                                            Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(
                                              builder: (_) => AirportshuttleViewManagePictures(),
                                            ),);
                                        ...
                                        InkWell(
                                          onTap: () async {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                  builder: (context) => AirportshuttleRatingScreen()),
                                            );
                                            // SharedPreferences prefs = await SharedPreferences.getInstance();
                                            // print('BusshuttleID id...');
                                            SharedPreferences prefs = await SharedPreferences.getInstance();

...
void main() => runApp(new Create_Auth_airlinescreen());

class Create_Auth_airlinescreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        //     color: Colors.green,
        // ),
        title: Text('Airlines',textAlign: TextAlign.center,
                                          ...
                                          return ListTile(
                                            ...
                                            onTap: () async {
                                              ...
                                              setState(() async {
                                                ...
                                                prefs.setString('airline_airportstrkey', (selectedStr));
                                                Navigator.push(
                                                  context,
                                                  MaterialPageRoute(

...
class FlightBackWardJourney extends StatefulWidget {
  const FlightBackWardJourney({super.key});

  @override
  State<FlightBackWardJourney> createState() => _userDashboardState();
}

class _userDashboardState extends State<FlightBackWardJourney> {
          ...
          for(var Durationstrv in itinerariesArray){
            ...
            for (var SegmentArray in itinerariesArray){
              ...
              for(var DeparturArray in segmentValuesAray){
                ...
                print('depiataCode...');
                print(depiataCode);
                if (depiataCode == Retrived_Rndtrp_Destination_iatacodestr){
                ...
                if(arrivalcode == Retrived_Rndtrp_iatacodestr){
                              ...
                              child: LayoutBuilder(
                                builder: (context, constraint) {
                                  ...
                                  if(FlightEmptyArray.length == 1) {
                                    ...
                                    Departuretextstr = 'Return To ' + ' '+  Retrived_Rndtrp_iatacodestr;

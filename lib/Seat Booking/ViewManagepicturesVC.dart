...
import 'BusAddimageVC.dart';
import 'MybusesVC.dart';
// import 'My_AprtmetsVC.dart';
// import 'ViewAddPicVC.dart';
class BusViewManagePictures extends StatefulWidget {

  const BusViewManagePictures({super.key});

  @override
  State<BusViewManagePictures> createState() => _userDashboardState();
}

class _userDashboardState extends State<BusViewManagePictures> {
...
//@override
  ...
  Future<void> _deleteData(int VehicleId, int Picture_Id) async {
    try {
      ...
      print(VehicleId);
      print(BusID);
      //https://staging.abisiniya.com/api/v1/bus/pictures/{bus_id}/{picture_id}
      var url = '';
      url = baseDioSingleton.AbisiniyaBaseurl + 'bus/pictures/$BusID/$Picture_Id';
  ...
  Future<dynamic> getData() async {
    ...
    //https://staging.abisiniya.com/api/v1/bus/auth/list
    print('manage busid.....');
    print(BusID);

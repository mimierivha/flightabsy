...
class ViewBusSearBookingScreen extends StatefulWidget {
  const ViewBusSearBookingScreen({super.key});

  @override
  State<ViewBusSearBookingScreen> createState() => _userDashboardState();
}

class _userDashboardState extends State<ViewBusSearBookingScreen> {
...
//@override
  ...
  Future<dynamic> getData() async {
    ...
    String url = baseDioSingleton.AbisiniyaBaseurl + 'bus/detail/' + BusID.toString();
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async{
                                            ...
                                            Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(
                                              builder: (_) => BusViewManagePictures(),
                                            ),);

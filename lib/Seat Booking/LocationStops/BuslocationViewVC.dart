...
class _LoginState extends State<BusLocationViewVC> {
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        child:isLoading
                                          ...
                                          child: const Text('Close',style: TextStyle(color:Colors.white,fontFamily: 'Baloo', fontWeight: FontWeight.w900,fontSize: 20)),
                                          onPressed: () async {
